...
| Calls | Step 93 audio polish complete | Firestore session/state API, atomic offer/accept, role-specific ICE paths, strict rules, WebRTC engine, STUN, and optional local TURN config exist; Step 90-91 calling flows implemented; Step 92 background notification implemented; Step 93 audio controls and foreground service implemented; Step 94 video call remains. |
