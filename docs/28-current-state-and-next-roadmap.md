...
| --- | --- | --- |
| Chat UI polish | Personal-beta code complete | Core text/media chat, actions, sync retry, notification navigation, secure read receipts, and custom doodle wallpaper integration (with real PNG assets) exist. |
